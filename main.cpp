...
int main() {
    try {
        ...
        huffman::writeZipFile("compressed.zip", encodedText, huffmanCodes, "input.txt");

        std::cout << "File compressed into 'compressed.zip'" << std::endl;

        // Decompress the file
        std::string decompressedText;
        huffman::decompressZipFile("compressed.zip", decompressedText);
